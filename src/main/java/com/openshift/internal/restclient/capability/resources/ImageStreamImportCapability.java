...
public class ImageStreamImportCapability implements IImageStreamImportCapability {
    ...
    public IImageStreamImport importImageMetadata(DockerImageURI uri) {
        ...
        IImageStreamImport streamImport = client.getResourceFactory().stub(PredefinedResourceKind.IMAGE_STREAM_IMPORT.getIdentifier(), "jbosstools-openshift-deployimage", project.getName());
