...
public class WebhookTriggerTest {
    ...
    public void testGetWebhookUrlWhenResourceHasBaseURL() {
        trigger = new WebhookTrigger(BuildTriggerType.GENERIC, "seCRet101",
                "https://localhost:8443/oapi/v1/namespaces/test/buildconfigs/foo");
        assertEquals("https://localhost:8443/oapi/v1/namespaces/test/buildconfigs/foo/webhooks/seCRet101/generic",
